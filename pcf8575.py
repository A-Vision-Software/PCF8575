#/*******************************************************************************
#*
#* File description :       PCF8575 IO expander chip python module
#*
#* Created by       :       Arnold Velzel
#* Created on       :       04-04-2022
#*
#* Required         :       apt-get install libffi-dev / pip install smbus
#*
#* Based on         :       https://pypi.org/project/pcf8575/
#*
#*******************************************************************************/
...
class PCF8575(object):
    ...
    def port(self, value):
        ...
        for i, val in enumerate(value):
            if val:
                new_state |= 1 << 15-i
        self.bus.write_byte_data(self.address, new_state & 0xffff, (new_state >> 8) & 0xffff)
